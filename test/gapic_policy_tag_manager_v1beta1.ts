...
describe('v1beta1.PolicyTagManagerClient', () => {
    ...
    describe('createTaxonomy', () => {
        it('invokes createTaxonomy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.CreateTaxonomyRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.Taxonomy());
            ...
            assert((client.innerApiCalls.createTaxonomy as SinonStub)
        ...
        it('invokes createTaxonomy with error', async () => {
            ...
            await assert.rejects(async () => { await client.createTaxonomy(request); }, expectedError);
            assert((client.innerApiCalls.createTaxonomy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteTaxonomy', () => {
        it('invokes deleteTaxonomy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.DeleteTaxonomyRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteTaxonomy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteTaxonomy with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteTaxonomy(request); }, expectedError);
            assert((client.innerApiCalls.deleteTaxonomy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateTaxonomy', () => {
        it('invokes updateTaxonomy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.UpdateTaxonomyRequest());
            request.taxonomy = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateTaxonomy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateTaxonomy with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateTaxonomy(request); }, expectedError);
            assert((client.innerApiCalls.updateTaxonomy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getTaxonomy', () => {
        it('invokes getTaxonomy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.GetTaxonomyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getTaxonomy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getTaxonomy with error', async () => {
            ...
            await assert.rejects(async () => { await client.getTaxonomy(request); }, expectedError);
            assert((client.innerApiCalls.getTaxonomy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createPolicyTag', () => {
        it('invokes createPolicyTag without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.PolicyTag());
            client.innerApiCalls.createPolicyTag = stubSimpleCall(expectedResponse);
            const [response] = await client.createPolicyTag(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createPolicyTag as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createPolicyTag with error', async () => {
            ...
            await assert.rejects(async () => { await client.createPolicyTag(request); }, expectedError);
            assert((client.innerApiCalls.createPolicyTag as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deletePolicyTag', () => {
        it('invokes deletePolicyTag without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.DeletePolicyTagRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deletePolicyTag as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deletePolicyTag with error', async () => {
            ...
            await assert.rejects(async () => { await client.deletePolicyTag(request); }, expectedError);
            assert((client.innerApiCalls.deletePolicyTag as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updatePolicyTag', () => {
        it('invokes updatePolicyTag without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.UpdatePolicyTagRequest());
            request.policyTag = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updatePolicyTag as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updatePolicyTag with error', async () => {
            ...
            await assert.rejects(async () => { await client.updatePolicyTag(request); }, expectedError);
            assert((client.innerApiCalls.updatePolicyTag as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getPolicyTag', () => {
        it('invokes getPolicyTag without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getPolicyTag as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getPolicyTag with error', async () => {
            ...
            await assert.rejects(async () => { await client.getPolicyTag(request); }, expectedError);
            assert((client.innerApiCalls.getPolicyTag as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listTaxonomies', () => {
        it('invokes listTaxonomies without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listTaxonomies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listTaxonomies with error', async () => {
            ...
            await assert.rejects(async () => { await client.listTaxonomies(request); }, expectedError);
            assert((client.innerApiCalls.listTaxonomies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listPolicyTags', () => {
        it('invokes listPolicyTags without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.ListPolicyTagsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listPolicyTags as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listPolicyTags with error', async () => {
            ...
            await assert.rejects(async () => { await client.listPolicyTags(request); }, expectedError);
            assert((client.innerApiCalls.listPolicyTags as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
