...
describe('v1beta1.DataCatalogClient', () => {
    ...
    describe('searchCatalog', () => {
        it('invokes searchCatalog without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.searchCatalog = (actualRequest: {}, options: {}, callback: Callback) => {
    ...
    describe('searchCatalogStream', () => {
        it('invokes searchCatalogStream without error', done => {
            ...
            const stream = client.searchCatalogStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
    ...
    describe('listEntryGroups', () => {
        it('invokes listEntryGroups without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listEntryGroups = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listEntryGroupsStream', () => {
        it('invokes listEntryGroupsStream without error', done => {
            ...
            const stream = client.listEntryGroupsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listEntries', () => {
        it('invokes listEntries without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listEntries = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listEntriesStream', () => {
        it('invokes listEntriesStream without error', done => {
            ...
            const stream = client.listEntriesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
