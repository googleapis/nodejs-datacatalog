...
describe('v1beta1.PolicyTagManagerSerializationClient', () => {
    ...
    describe('importTaxonomies', () => {
        it('invokes importTaxonomies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.ImportTaxonomiesRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.ImportTaxonomiesResponse());
        ...
        it('invokes importTaxonomies with error', async () => {
            ...
            await assert.rejects(async () => { await client.importTaxonomies(request); }, expectedError);
            assert((client.innerApiCalls.importTaxonomies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('exportTaxonomies', () => {
        it('invokes exportTaxonomies without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datacatalog.v1beta1.ExportTaxonomiesResponse());
        ...
        it('invokes exportTaxonomies with error', async () => {
            ...
            await assert.rejects(async () => { await client.exportTaxonomies(request); }, expectedError);
            assert((client.innerApiCalls.exportTaxonomies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
