...
describe('v1.PolicyTagManagerSerializationClient', () => {
    ...
    describe('replaceTaxonomy', () => {
        it('invokes replaceTaxonomy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1.ReplaceTaxonomyRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datacatalog.v1.Taxonomy());
            ...
            assert((client.innerApiCalls.replaceTaxonomy as SinonStub)
    ...
    describe('importTaxonomies', () => {
        it('invokes importTaxonomies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1.ImportTaxonomiesRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datacatalog.v1.ImportTaxonomiesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.importTaxonomies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('exportTaxonomies', () => {
        it('invokes exportTaxonomies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datacatalog.v1.ExportTaxonomiesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datacatalog.v1.ExportTaxonomiesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportTaxonomies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
