...
describe('v1beta1.DataCatalogClient', () => {
    ...
    describe('createEntryGroup', () => {
        it('invokes createEntryGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.CreateEntryGroupRequest', ['parent']);
    ...
    describe('updateEntryGroup', () => {
        it('invokes updateEntryGroup without error', async () => {
            ...
            request.entryGroup ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.UpdateEntryGroupRequest', ['entryGroup', 'name']);
    ...
    describe('getEntryGroup', () => {
        it('invokes getEntryGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.GetEntryGroupRequest', ['name']);
    ...
    describe('deleteEntryGroup', () => {
        it('invokes deleteEntryGroup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.DeleteEntryGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createEntry', () => {
        it('invokes createEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.CreateEntryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateEntry', () => {
        it('invokes updateEntry without error', async () => {
            ...
            request.entry ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.UpdateEntryRequest', ['entry', 'name']);
    ...
    describe('deleteEntry', () => {
        it('invokes deleteEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.DeleteEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getEntry', () => {
        it('invokes getEntry without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.GetEntryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1beta1.Entry()
    ...
    describe('createTagTemplate', () => {
        it('invokes createTagTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.CreateTagTemplateRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getTagTemplate', () => {
        it('invokes getTagTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.GetTagTemplateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1beta1.TagTemplate()
    ...
    describe('updateTagTemplate', () => {
        it('invokes updateTagTemplate without error', async () => {
            ...
            request.tagTemplate ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.UpdateTagTemplateRequest', ['tagTemplate', 'name']);
    ...
    describe('deleteTagTemplate', () => {
        it('invokes deleteTagTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.DeleteTagTemplateRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createTagTemplateField', () => {
        it('invokes createTagTemplateField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.CreateTagTemplateFieldRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateTagTemplateField', () => {
        it('invokes updateTagTemplateField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.UpdateTagTemplateFieldRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1beta1.TagTemplateField()
    ...
    describe('renameTagTemplateField', () => {
        it('invokes renameTagTemplateField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.RenameTagTemplateFieldRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.datacatalog.v1beta1.TagTemplateField()
    ...
    describe('deleteTagTemplateField', () => {
        it('invokes deleteTagTemplateField without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.DeleteTagTemplateFieldRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createTag', () => {
        it('invokes createTag without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.CreateTagRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateTag', () => {
        it('invokes updateTag without error', async () => {
            ...
            request.tag ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.UpdateTagRequest', ['tag', 'name']);
    ...
    describe('deleteTag', () => {
        it('invokes deleteTag without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.DeleteTagRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('listEntryGroups', () => {
        it('invokes listEntryGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.ListEntryGroupsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listEntries', () => {
        it('invokes listEntries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.ListEntriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listTags', () => {
        it('invokes listTags without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.datacatalog.v1beta1.ListTagsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
